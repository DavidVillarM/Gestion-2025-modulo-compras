...
import {
  ...
  FaHotel,
  FaFileInvoice,
  FaChair // <- nuevo icono para Asientos
} from "react-icons/fa";
    ...
    <div className="flex h-screen fix-top">
      ...
      <aside className="w-64 bg-sky-600 text-white p-4 overflow-y-auto">
        ...
        <nav className="flex flex-col gap-4">
          {/* Gestion General */}
          <div>
            <h2 className="uppercase text-sm text-gray-200 mb-2">Gestion General</h2>
          ...
          {/* Ordenes y Finanzas */}
          <div>
            <h2 className="uppercase text-sm text-gray-200 mb-2">Ordenes y Finanzas</h2>
