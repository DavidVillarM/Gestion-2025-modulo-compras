...
namespace BackendApp.Controllers
{
    ...
    public class ProveedoresController : ControllerBase
    {
        ...
        public ProveedoresController(PostgresContext context)
        {
            _context = context;
        }
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Proveedore>> GetProveedor(long id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutProveedor(long id, Proveedore proveedor)
        {
